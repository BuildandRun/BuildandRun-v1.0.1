...
<head>
  ...
  <link rel="apple-touch-icon" sizes="180x180" href="bandr/footer.png">
  <link rel="icon" type="image/png" sizes="32x32" href="bandr/faviconBR.png">
  <link rel="icon" type="image/png" sizes="16x16" href="bandr/faviconBR.png">
  <link rel="manifest" href="img/site.webmanifest">
  <link rel="mask-icon" href="img/safari-pinned-tab.svg" color="#5bbad5">
  <meta name="msapplication-TileColor" content="#da532c">
  <meta name="theme-color" content="#ffffff">
  <meta name="description" content="B&R Store - Introducing the Future">
  <meta name="twitter:card" content="summary">
  <meta name="twitter:site" content="@BandR">
    ...
    <div class="outer__content">
      <div class="section post">
        <div class="post__center center">
          <h1 class="post__title hero">Build and Run</h1>
          <div class="post__info">Select the black icon "Terms & Privacy" to open a new tab.</div>
          <div class="history">
            <div class="post__nav"><a class="post__link js-tabs-link" href="terms.php">Terms Of Service</a><a
                class="post__link js-tabs-link active" href="#">Privacy Policy</a><a class="post__link js-tabs-link"
                href="./tech/pricing/">FAQs</a></div>
            <div class="post__container">
              <div class="post__box js-tabs-item">
                <div class="post__info" action="best" href="test.html">Privacy Policy <a href="Privacy">
                  <img src="terms.png" alt="my picture" height="80" width="80" />
                </a> </div>
               
                <p>
                  <center>
                    Your privacy is important to us (but you already knew that). It’s our policy to respect your privacy and comply with any applicable law and regulation regarding the personal information we collect about you through this website, Build and Run, and through any associated services and third-party platforms we may use.</center>
                </p>

                <embed src="Privacy" type="application/pdf" width="100%" height="600px" />
      </div>
    </div>
  </div>
  <!-- footer-->
          ...
          <div class="footer__box"><a class="footer__logo" href="index.html"><img class="some-icon"
            ...
            <label class="theme js-theme">
              <input class="theme__input" type="checkbox" /><span class="theme__inner"><span
                  class="theme__box"></span><span class="theme__icon">
